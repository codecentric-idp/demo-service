# Podinfo - Demo-service

[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/codecentric-idp/demo-service)
...
humctl config set app demo-service
